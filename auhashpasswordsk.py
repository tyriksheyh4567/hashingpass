#Orignal author: yarosheyh/tyriksheyh4567/Yaromir Sheydaev. No need for credit if you fork it (even if your code will be closed source).
#This is public domain, everything about things you can do with the code is in the LICENSE file.
#Ver 1.2. Made in 06.03.2025. Updated the comments.
